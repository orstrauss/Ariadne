 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel editDirectory='/fr.obeo.ariadne.model.organization.edit/src-gen' editorDirectory='/fr.obeo.ariadne.model.organization.editor/src-gen' fileExtensions='ariadneorganization' copyrightText='Copyright (c) 2012 Obeo.\r\nAll rights reserved. This program and the accompanying materials\r\nare made available under the terms of the Eclipse Public License v1.0\r\nwhich accompanies this distribution, and is available at\r\nhttp://www.eclipse.org/legal/epl-v10.html\r\n\r\nContributors:\r\n    Stephane Begaudeau (Obeo) - initial API and implementation' basePackage='fr.obeo.ariadne.model'"
 * @generated
 */
public interface OrganizationPackage extends EPackage
{
   ...
   * @ordered
   */
  int ORGANIZATION__MEGA_MODELS = 9;
   ...
   * @ordered
   */
  int ORGANIZATION_FEATURE_COUNT = 10;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.obeo.ariadne.model.organization.Organization#getMegaModels <em>Mega Models</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Mega Models</em>'.
   * @see fr.obeo.ariadne.model.organization.Organization#getMegaModels()
   * @see #getOrganization()
   * @generated
   */
  EReference getOrganization_MegaModels();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference ORGANIZATION__MEGA_MODELS = eINSTANCE.getOrganization_MegaModels();
