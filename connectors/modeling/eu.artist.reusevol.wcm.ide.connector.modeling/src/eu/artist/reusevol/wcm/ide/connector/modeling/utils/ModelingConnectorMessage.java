...
/**
 * Utility class used for the internationalization of the messages of the modeling connector.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class ModelingConnectorMessage {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "eu.artist.reusevol.wcm.ide.connector.modeling.utils.modelingmessages"; //$NON-NLS-1$
	 ...
	 */
	private ModelingConnectorMessage() {
